...
public class VisibleTarget : Target {
	GameObject target;
	...
	private Vector3 universalCircleRadius {
		get {
			...
			Vector3 circleXYEdgePosition =
				mapper.getWorldPointFromRelativePoint(new Vector3(relativeCircleRadius, relativeCircleRadius, 0f));
	...
	public VisibleTarget(float x, float y)
		: base(x, y) {
	...
	protected override void UpdateTargetGraphic() {
		if (targetState == 1) {
	...
	public override void ExplosionGraphics() {
